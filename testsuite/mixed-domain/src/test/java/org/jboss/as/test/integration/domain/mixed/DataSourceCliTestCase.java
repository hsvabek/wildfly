 ...
 */
public abstract class DataSourceCliTestCase extends AbstractCliTestBase {
    ...
    public void init() throws Exception {
         profileNames = serverProfiles.keySet().toArray(new String[serverProfiles.size()]);
    }
...
//        cli.sendLine("data-source add --profile=" + profileNames[0] + " --jndi-name=java:jboss/datasources/TestDS --name=java:jboss/datasources/TestDS --driver-name=h2 --connection-url=jdbc:h2:mem:test;DB_CLOSE_DELAY=-1");
        cli.sendLine("data-source add --profile=full-ha --jndi-name=java:jboss/datasources/TestDS --name=java:jboss/datasources/TestDS --driver-name=h2 --connection-url=jdbc:h2:mem:test;DB_CLOSE_DELAY=-1 --statistics-enabled=true");
    ...
    private void testAddXaDataSource() throws Exception {
        ...
        cli.sendLine("xa-data-source add --profile=" + profileNames[0] +
                " --jndi-name=java:jboss/datasources/TestXADS --name=java:jboss/datasources/TestXADS --driver-name=h2 --statistics-enabled=true --xa-datasource-properties=ServerName=localhost,PortNumber=50011");
