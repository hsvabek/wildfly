...
public class CLIWrapper {
    ...
    public CLIWrapper(boolean connect, String cliAddress, InputStream consoleInput) throws CliInitializationException {
        ...
        ctx = CLITestUtil.getCommandContext(
                //TODO Hynek 24.8.2015 9999 parameter!! We need EAP7 support too...
                TestSuiteEnvironment.getServerAddress(), 9999,//TestSuiteEnvironment.getServerPort()
    ...
    public final boolean sendConnect(String cliAddress) {
        try {
            if (cliAddress!=null) {
                //TODO Hynek 24.8.2015 9999 parameter!! We need EAP7 support too...
                ctx.connectController(new URI("remoting", null, cliAddress, 9999, null, null, null).toString());
