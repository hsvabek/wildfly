...
public class SlaveHostControllerAuthentication640TestCase extends SlaveHostControllerAuthenticationTestCase{

    @BeforeClass
    public static void beforeClass() throws Exception {
        before(SlaveHostControllerAuthentication640TestCase.class);
    }
}
