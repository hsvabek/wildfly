...
import org.jboss.as.test.integration.domain.mixed.DeploymentOverlayTestCase;
...
public class DeploymentOverlay640TestCase extends DeploymentOverlayTestCase{

    @BeforeClass
    public static void beforeClass() throws Exception {
        before(DeploymentOverlay640TestCase.class);
    }
