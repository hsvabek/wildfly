...
import org.jboss.as.test.integration.domain.mixed.DatasourceTestCase;
...
public class Datasource640TestCase extends DatasourceTestCase {

    @BeforeClass
    public static void beforeClass() throws Exception {
        before(Datasource640TestCase.class);
    }
