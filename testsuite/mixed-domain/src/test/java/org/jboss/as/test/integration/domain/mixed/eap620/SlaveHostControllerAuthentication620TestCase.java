...
public class SlaveHostControllerAuthentication620TestCase extends SlaveHostControllerAuthenticationTestCase{

    @BeforeClass
    public static void beforeClass() throws Exception {
        before(SlaveHostControllerAuthentication620TestCase.class);
    }
}
